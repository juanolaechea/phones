...
public class EmployeeBackController {
    ...
    public PostResponse addEmployee(@RequestBody Employee employee)  throws ElementExistsException
    {
    ...
    public Employee getById(@PathVariable("idEmployee") Integer idEmployee){
        return this.employeeService.getById(idEmployee);
    }

    @PutMapping(path = URL_EMPLOYEE + "/{idEmployee}" + URl_USER + "/{idUser}")
    public PostResponse putUserInEmployee(@PathVariable("idEmployee") Integer idEmployee, @PathVariable("idUser") Integer idUser) throws ElementDoesNotExistsException, BadRequestException {
